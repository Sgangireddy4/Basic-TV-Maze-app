...
export class ShowServiceFake implements IShowService{
    ...
    private fakeShows: IShowDetails[] = [{name: 'Girls',language: 'English',genre: ['comedy', 'tragedy'],rating: 8, channel: 'K5',runtime: 30,
        ...
        image: '../assets/check.png'}, {name: 'Girls',language: 'English',genre: ['comedy', 'tragedy'],rating: 8, channel: 'K5',runtime: 30,
        summary: 'This is a fake show for fake showservice testing',image: '../assets/check.png'} ]
